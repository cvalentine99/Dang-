...
// ═══════════════════════════════════════════════════════════════════════
// SIEM EVENTS (normalized security events with full alert structure)
// ═══════════════════════════════════════════════════════════════════════
export const MOCK_SIEM_EVENTS = [
  {
    id: "1708549110.284756",
    timestamp: "2026-02-21T21:58:30Z",
    agent: { id: "002", name: "web-server-prod-01", ip: "10.0.1.10" },
    rule: { id: 5710, level: 14, description: "sshd: Attempt to login using a denied user.", groups: ["syslog", "sshd", "authentication_failed"], mitre: { id: ["T1110"], tactic: ["Credential Access"], technique: ["Brute Force"] }, pci_dss: ["10.2.4", "10.2.5"], gdpr: ["IV_35.7.d", "IV_32.2"], hipaa: ["164.312.b"], firedtimes: 47 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "185.220.101.34", srcport: "44521", dstuser: "admin", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:58:30 web-server-prod-01 sshd[28456]: Failed password for invalid user admin from 185.220.101.34 port 44521 ssh2",
  },
  {
    id: "1708549112.284890",
    timestamp: "2026-02-21T21:55:12Z",
    agent: { id: "004", name: "win-dc-01", ip: "10.0.3.5" },
    rule: { id: 87105, level: 15, description: "Windows: Mimikatz detected on system.", groups: ["windows", "attack", "credential_theft"], mitre: { id: ["T1003"], tactic: ["Credential Access"], technique: ["OS Credential Dumping"] }, pci_dss: ["10.2.7", "10.6.1"], gdpr: ["IV_35.7.d"], hipaa: ["164.312.b"], firedtimes: 3 },
    decoder: { name: "windows_eventchannel", parent: "windows" },
    data: { srcip: "10.0.3.5", dstuser: "SYSTEM", win: { system: { eventID: "1", providerName: "Microsoft-Windows-Sysmon" }, eventdata: { image: "C:\\Windows\\Temp\\mimikatz.exe", commandLine: "mimikatz.exe sekurlsa::logonpasswords", hashes: "SHA256=a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2" } } },
    location: "EventChannel",
    full_log: "Sysmon Event 1: Process Create - mimikatz.exe sekurlsa::logonpasswords (PID: 7892, User: SYSTEM)",
  },
  {
    id: "1708549115.285012",
    timestamp: "2026-02-21T21:52:45Z",
    agent: { id: "003", name: "db-server-prod-01", ip: "10.0.2.20" },
    rule: { id: 5501, level: 5, description: "Login session opened.", groups: ["pam", "syslog", "authentication_success"], mitre: { id: ["T1078"], tactic: ["Defense Evasion", "Persistence", "Privilege Escalation", "Initial Access"], technique: ["Valid Accounts"] }, pci_dss: ["10.2.5"], gdpr: ["IV_32.2"], hipaa: ["164.312.d"], firedtimes: 234 },
    decoder: { name: "pam", parent: "pam" },
    data: { srcip: "10.0.7.50", dstuser: "dbadmin", uid: "1001", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:52:45 db-server-prod-01 sshd(pam_unix)[29012]: session opened for user dbadmin by (uid=0)",
  },
  {
    id: "1708549118.285134",
    timestamp: "2026-02-21T21:50:00Z",
    agent: { id: "002", name: "web-server-prod-01", ip: "10.0.1.10" },
    rule: { id: 80791, level: 13, description: "Shellshock attack detected.", groups: ["web", "attack", "shellshock"], mitre: { id: ["T1190"], tactic: ["Initial Access"], technique: ["Exploit Public-Facing Application"] }, pci_dss: ["6.5", "6.6", "11.4"], gdpr: ["IV_35.7.d"], hipaa: [], firedtimes: 12 },
    decoder: { name: "web-accesslog", parent: "web-accesslog" },
    data: { srcip: "45.33.32.156", srcport: "51234", url: "/cgi-bin/test.cgi", protocol: "HTTP/1.1", id: "200" },
    location: "/var/log/nginx/access.log",
    full_log: '45.33.32.156 - - [21/Feb/2026:21:50:00 +0000] "GET /cgi-bin/test.cgi HTTP/1.1" 200 0 "() { :; }; /bin/bash -c \'cat /etc/passwd\'"',
  },
  {
    id: "1708549120.285256",
    timestamp: "2026-02-21T21:47:33Z",
    agent: { id: "003", name: "db-server-prod-01", ip: "10.0.2.20" },
    rule: { id: 60103, level: 12, description: "Integrity checksum changed.", groups: ["ossec", "syscheck", "syscheck_entry_modified"], mitre: { id: ["T1565.001"], tactic: ["Impact"], technique: ["Stored Data Manipulation"] }, pci_dss: ["11.5"], gdpr: ["II_5.1.f"], hipaa: ["164.312.c.1"], firedtimes: 8 },
    decoder: { name: "syscheck_integrity_changed", parent: "syscheck" },
    data: { path: "/etc/shadow", size_before: "1489", size_after: "1523", md5_before: "abc123", md5_after: "def456", sha256_before: "111aaa", sha256_after: "222bbb", uid_after: "0", gid_after: "42", perm_after: "100640" },
    location: "syscheck",
    full_log: "File '/etc/shadow' checksum changed. Size changed from '1489' to '1523'. MD5 changed. SHA256 changed.",
  },
  {
    id: "1708549122.285378",
    timestamp: "2026-02-21T21:45:10Z",
    agent: { id: "007", name: "vpn-gateway-01", ip: "10.0.6.1" },
    rule: { id: 5712, level: 10, description: "sshd: brute force trying to get access to the system.", groups: ["syslog", "sshd", "authentication_failed"], mitre: { id: ["T1110.001"], tactic: ["Credential Access"], technique: ["Password Guessing"] }, pci_dss: ["10.2.4", "10.2.5", "11.4"], gdpr: ["IV_35.7.d"], hipaa: ["164.312.b"], firedtimes: 156 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "103.75.190.11", srcport: "38901", dstuser: "root", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:45:10 vpn-gateway-01 sshd[30123]: Failed password for root from 103.75.190.11 port 38901 ssh2",
  },
  {
    id: "1708549125.285500",
    timestamp: "2026-02-21T21:42:00Z",
    agent: { id: "005", name: "k8s-worker-01", ip: "10.0.4.100" },
    rule: { id: 92655, level: 12, description: "Docker: Container started with privileged mode.", groups: ["docker", "container"], mitre: { id: ["T1610"], tactic: ["Execution"], technique: ["Deploy Container"] }, pci_dss: ["2.2"], gdpr: ["IV_35.7.d"], hipaa: [], firedtimes: 5 },
    decoder: { name: "json", parent: "json" },
    data: { docker: { id: "a1b2c3d4e5f6", name: "suspicious-container", image: "alpine:latest", action: "start", type: "container", Actor: { Attributes: { "com.docker.compose.project": "unknown" } } } },
    location: "/var/log/docker.log",
    full_log: '{"status":"start","id":"a1b2c3d4e5f6","from":"alpine:latest","Type":"container","Action":"start","time":1708549325}',
  },
  {
    id: "1708549128.285622",
    timestamp: "2026-02-21T21:40:15Z",
    agent: { id: "005", name: "k8s-worker-01", ip: "10.0.4.100" },
    rule: { id: 5706, level: 6, description: "OpenSSH: authentication success.", groups: ["syslog", "sshd", "authentication_success"], mitre: { id: ["T1078"], tactic: ["Defense Evasion", "Persistence", "Privilege Escalation", "Initial Access"], technique: ["Valid Accounts"] }, pci_dss: ["10.2.5"], gdpr: ["IV_32.2"], hipaa: ["164.312.d"], firedtimes: 891 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "10.0.0.2", srcport: "55678", dstuser: "k8sadmin", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:40:15 k8s-worker-01 sshd[31234]: Accepted publickey for k8sadmin from 10.0.0.2 port 55678 ssh2: RSA SHA256:abc123def456",
  },
  {
    id: "1708549130.285744",
    timestamp: "2026-02-21T21:38:22Z",
    agent: { id: "011", name: "firewall-01", ip: "10.0.10.1" },
    rule: { id: 100002, level: 10, description: "Suricata: ET MALWARE Known Malicious User-Agent.", groups: ["ids", "suricata"], mitre: { id: ["T1071.001"], tactic: ["Command and Control"], technique: ["Web Protocols"] }, pci_dss: ["10.6.1", "11.4"], gdpr: ["IV_35.7.d"], hipaa: ["164.312.b"], firedtimes: 23 },
    decoder: { name: "json", parent: "suricata" },
    data: { srcip: "192.168.1.105", srcport: "49876", dstip: "91.215.85.209", dstport: "443", alert: { signature: "ET MALWARE Known Malicious User-Agent (Cobalt Strike)", category: "A Network Trojan was detected", severity: 1, signature_id: 2033076 } },
    location: "/var/log/suricata/eve.json",
    full_log: '{"timestamp":"2026-02-21T21:38:22Z","event_type":"alert","src_ip":"192.168.1.105","src_port":49876,"dest_ip":"91.215.85.209","dest_port":443,"proto":"TCP","alert":{"action":"allowed","gid":1,"signature_id":2033076,"rev":1,"signature":"ET MALWARE Known Malicious User-Agent (Cobalt Strike)","category":"A Network Trojan was detected","severity":1}}',
  },
  {
    id: "1708549132.285866",
    timestamp: "2026-02-21T21:35:00Z",
    agent: { id: "002", name: "web-server-prod-01", ip: "10.0.1.10" },
    rule: { id: 31104, level: 6, description: "Web server 404 error.", groups: ["web", "accesslog"], mitre: { id: ["T1595.002"], tactic: ["Reconnaissance"], technique: ["Vulnerability Scanning"] }, pci_dss: ["10.6.1"], gdpr: [], hipaa: [], firedtimes: 1456 },
    decoder: { name: "web-accesslog", parent: "web-accesslog" },
    data: { srcip: "45.33.32.156", srcport: "51235", url: "/wp-admin/setup-config.php", protocol: "HTTP/1.1", id: "404" },
    location: "/var/log/nginx/access.log",
    full_log: '45.33.32.156 - - [21/Feb/2026:21:35:00 +0000] "GET /wp-admin/setup-config.php HTTP/1.1" 404 162 "-" "Mozilla/5.0 (compatible; Nmap Scripting Engine)"',
  },
  {
    id: "1708549134.285988",
    timestamp: "2026-02-21T21:32:45Z",
    agent: { id: "004", name: "win-dc-01", ip: "10.0.3.5" },
    rule: { id: 18104, level: 12, description: "Windows Audit: Logon failure - Unknown user or bad password.", groups: ["windows", "authentication_failed"], mitre: { id: ["T1110"], tactic: ["Credential Access"], technique: ["Brute Force"] }, pci_dss: ["10.2.4", "10.2.5"], gdpr: ["IV_35.7.d", "IV_32.2"], hipaa: ["164.312.b"], firedtimes: 89 },
    decoder: { name: "windows_eventchannel", parent: "windows" },
    data: { srcip: "10.0.11.25", dstuser: "Administrator", win: { system: { eventID: "4625", providerName: "Microsoft-Windows-Security-Auditing" }, eventdata: { logonType: "3", status: "0xC000006D", subStatus: "0xC000006A", workstationName: "WIN-ENDPOINT-01" } } },
    location: "EventChannel",
    full_log: "Windows Security Event 4625: An account failed to log on. Subject: WIN-ENDPOINT-01. Logon Type: 3. Account: Administrator. Source: 10.0.11.25. Status: 0xC000006D",
  },
  {
    id: "1708549136.286110",
    timestamp: "2026-02-21T21:30:10Z",
    agent: { id: "007", name: "vpn-gateway-01", ip: "10.0.6.1" },
    rule: { id: 5763, level: 10, description: "sshd: Possible SSH scan.", groups: ["syslog", "sshd", "recon"], mitre: { id: ["T1046"], tactic: ["Discovery"], technique: ["Network Service Discovery"] }, pci_dss: ["11.4"], gdpr: ["IV_35.7.d"], hipaa: [], firedtimes: 67 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "198.51.100.23", srcport: "12345", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:30:10 vpn-gateway-01 sshd[32345]: Connection closed by 198.51.100.23 port 12345 [preauth]",
  },
  {
    id: "1708549138.286232",
    timestamp: "2026-02-21T21:28:00Z",
    agent: { id: "009", name: "backup-server-01", ip: "10.0.8.30" },
    rule: { id: 5502, level: 3, description: "Login session closed.", groups: ["pam", "syslog"], mitre: { id: [], tactic: [], technique: [] }, pci_dss: ["10.2.5"], gdpr: [], hipaa: [], firedtimes: 567 },
    decoder: { name: "pam", parent: "pam" },
    data: { dstuser: "backupadmin", uid: "1002", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:28:00 backup-server-01 sshd(pam_unix)[33456]: session closed for user backupadmin",
  },
  {
    id: "1708549140.286354",
    timestamp: "2026-02-21T21:25:30Z",
    agent: { id: "006", name: "mail-server-01", ip: "10.0.5.15" },
    rule: { id: 550, level: 10, description: "Integrity checksum changed (2nd time).", groups: ["ossec", "syscheck"], mitre: { id: ["T1565.001"], tactic: ["Impact"], technique: ["Stored Data Manipulation"] }, pci_dss: ["11.5"], gdpr: ["II_5.1.f"], hipaa: ["164.312.c.1"], firedtimes: 4 },
    decoder: { name: "syscheck_integrity_changed", parent: "syscheck" },
    data: { path: "/etc/postfix/main.cf", size_before: "27800", size_after: "27832", md5_before: "aaa111", md5_after: "bbb222" },
    location: "syscheck",
    full_log: "File '/etc/postfix/main.cf' checksum changed (2nd time). Size changed from '27800' to '27832'.",
  },
  {
    id: "1708549142.286476",
    timestamp: "2026-02-21T21:22:00Z",
    agent: { id: "009", name: "backup-server-01", ip: "10.0.8.30" },
    rule: { id: 5710, level: 14, description: "sshd: Attempt to login using a denied user.", groups: ["syslog", "sshd", "authentication_failed"], mitre: { id: ["T1110"], tactic: ["Credential Access"], technique: ["Brute Force"] }, pci_dss: ["10.2.4", "10.2.5"], gdpr: ["IV_35.7.d", "IV_32.2"], hipaa: ["164.312.b"], firedtimes: 47 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "185.220.101.34", srcport: "44890", dstuser: "oracle", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:22:00 backup-server-01 sshd[34567]: Failed password for invalid user oracle from 185.220.101.34 port 44890 ssh2",
  },
  {
    id: "1708549144.286598",
    timestamp: "2026-02-21T21:18:45Z",
    agent: { id: "004", name: "win-dc-01", ip: "10.0.3.5" },
    rule: { id: 18104, level: 12, description: "Windows Audit: Logon failure - Unknown user or bad password.", groups: ["windows", "authentication_failed"], mitre: { id: ["T1110"], tactic: ["Credential Access"], technique: ["Brute Force"] }, pci_dss: ["10.2.4", "10.2.5"], gdpr: ["IV_35.7.d", "IV_32.2"], hipaa: ["164.312.b"], firedtimes: 90 },
    decoder: { name: "windows_eventchannel", parent: "windows" },
    data: { srcip: "10.0.11.25", dstuser: "svc_sql", win: { system: { eventID: "4625", providerName: "Microsoft-Windows-Security-Auditing" }, eventdata: { logonType: "3", status: "0xC000006D", subStatus: "0xC0000064", workstationName: "WIN-ENDPOINT-01" } } },
    location: "EventChannel",
    full_log: "Windows Security Event 4625: An account failed to log on. Subject: WIN-ENDPOINT-01. Logon Type: 3. Account: svc_sql. Source: 10.0.11.25. Status: 0xC000006D",
  },
  {
    id: "1708549146.286720",
    timestamp: "2026-02-21T21:15:30Z",
    agent: { id: "001", name: "wazuh-manager", ip: "10.0.0.2" },
    rule: { id: 5706, level: 6, description: "OpenSSH: authentication success.", groups: ["syslog", "sshd", "authentication_success"], mitre: { id: ["T1078"], tactic: ["Defense Evasion", "Persistence", "Privilege Escalation", "Initial Access"], technique: ["Valid Accounts"] }, pci_dss: ["10.2.5"], gdpr: ["IV_32.2"], hipaa: ["164.312.d"], firedtimes: 892 },
    decoder: { name: "sshd", parent: "sshd" },
    data: { srcip: "10.0.7.50", srcport: "56789", dstuser: "wazuhadmin", program_name: "sshd" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:15:30 wazuh-manager sshd[35678]: Accepted publickey for wazuhadmin from 10.0.7.50 port 56789 ssh2: ED25519 SHA256:xyz789abc123",
  },
  {
    id: "1708549148.286842",
    timestamp: "2026-02-21T21:12:15Z",
    agent: { id: "011", name: "firewall-01", ip: "10.0.10.1" },
    rule: { id: 100002, level: 10, description: "Suricata: ET MALWARE Known Malicious User-Agent.", groups: ["ids", "suricata"], mitre: { id: ["T1071.001"], tactic: ["Command and Control"], technique: ["Web Protocols"] }, pci_dss: ["10.6.1", "11.4"], gdpr: ["IV_35.7.d"], hipaa: ["164.312.b"], firedtimes: 24 },
    decoder: { name: "json", parent: "suricata" },
    data: { srcip: "192.168.1.108", srcport: "50123", dstip: "91.215.85.209", dstport: "8443", alert: { signature: "ET MALWARE Cobalt Strike Beacon Observed", category: "A Network Trojan was detected", severity: 1, signature_id: 2033077 } },
    location: "/var/log/suricata/eve.json",
    full_log: '{"timestamp":"2026-02-21T21:12:15Z","event_type":"alert","src_ip":"192.168.1.108","dest_ip":"91.215.85.209","alert":{"signature":"ET MALWARE Cobalt Strike Beacon Observed","severity":1}}',
  },
  {
    id: "1708549150.286964",
    timestamp: "2026-02-21T21:08:00Z",
    agent: { id: "003", name: "db-server-prod-01", ip: "10.0.2.20" },
    rule: { id: 5501, level: 5, description: "Login session opened.", groups: ["pam", "syslog", "authentication_success"], mitre: { id: ["T1078"], tactic: ["Defense Evasion", "Persistence", "Privilege Escalation", "Initial Access"], technique: ["Valid Accounts"] }, pci_dss: ["10.2.5"], gdpr: ["IV_32.2"], hipaa: ["164.312.d"], firedtimes: 235 },
    decoder: { name: "pam", parent: "pam" },
    data: { srcip: "10.0.0.2", dstuser: "postgres", uid: "108", program_name: "su" },
    location: "/var/log/auth.log",
    full_log: "Feb 21 21:08:00 db-server-prod-01 su(pam_unix)[36789]: session opened for user postgres by root(uid=0)",
  },
  {
    id: "1708549152.287086",
    timestamp: "2026-02-21T21:05:45Z",
    agent: { id: "002", name: "web-server-prod-01", ip: "10.0.1.10" },
    rule: { id: 31105, level: 6, description: "Web server 500 error (Internal Error).", groups: ["web", "accesslog"], mitre: { id: [], tactic: [], technique: [] }, pci_dss: ["10.6.1"], gdpr: [], hipaa: [], firedtimes: 34 },
    decoder: { name: "web-accesslog", parent: "web-accesslog" },
    data: { srcip: "10.0.7.50", srcport: "51236", url: "/api/v2/reports/generate", protocol: "HTTP/1.1", id: "500" },
    location: "/var/log/nginx/access.log",
    full_log: '10.0.7.50 - dbadmin [21/Feb/2026:21:05:45 +0000] "POST /api/v2/reports/generate HTTP/1.1" 500 0 "-" "curl/8.5.0"',
  },
];

// SIEM event source categories for filtering
export const MOCK_LOG_SOURCES = [
  { name: "sshd", count: 6, category: "Authentication" },
  { name: "windows_eventchannel", count: 3, category: "Windows" },
  { name: "syscheck", count: 2, category: "Integrity" },
  { name: "web-accesslog", count: 3, category: "Web" },
  { name: "suricata", count: 2, category: "IDS/IPS" },
  { name: "pam", count: 2, category: "Authentication" },
